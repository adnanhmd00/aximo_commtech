...
<body class="">
                                ...
                                <div id="list-view" class="tab-pane fade active show col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Dealership Registration</h4>
                                            <!-- <a href="add-dealership.php" class="btn btn-primary">+ Add new</a> -->
                                        </div>
                                        <div class="card-body">
    ...
    <div class="modal fade" id="editdealer" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                <form method="post" action="update_dealer">
                                {{csrf_field()}}
