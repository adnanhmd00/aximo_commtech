                                ...
                                <div id="list-view" class="tab-pane fade active show col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Update Recovered Vehicle/Motorbike</h4>
...
<div class="modal fade" id="editupdaterecovered" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                <form method="post" action="update_updaterecovered">
                                {{csrf_field()}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <label>City Where Recovered</label>
                                                
                                                <input type="text" id="city" name="city_whereRecovered" class="form-control" placeholder="City Where Recovered" value={{$data[0]->city_whereRecovered}}>
                                            </div>
                                        </div>
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="police" name="police_station" class="form-control" placeholder="Police Station" value={{$data[0]->police_station}}>
                                            </div>
                                        </div>
  ...
  $(function () {
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'recovered_city',       name: 'recovered_city'},
