                                ...
                                <div id="list-view" class="tab-pane fade active show col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Report a Stolen Vehicle/Motorcycle to us</h4>
...
<div class="modal fade" id="editstolen" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                <form method="post" action="update_stolen">
                                {{csrf_field()}}
                                    ...
                                    <div class="col-md-6 pr-1">
                                        ...
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <label>Where Stolen</label>
                                                
                                                <input type="text" id="where_stolen" name="city_whereStolen" class="form-control" placeholder="Where Stolen" value={{$data[0]->city_whereStolen}}>
                                            </div>
                                        </div>
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="police_station" name="police_station" class="form-control" placeholder="Police station name" value={{$data[0]->police_station}}>
                                            </div>
                                        </div>
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                            
                                                <label>Police Crime Number</label>
                                                
                                                <input type="text" id="police_crime_no" name="police_crime_no" class="form-control" placeholder="police crime number" value={{$data[0]->police_crime_no}}>
                                            </div>
                                        </div>
                                    <div class="row">
  ...
  $(function () {
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'where_stolen', name: 'where_stolen'},
            {data: 'country',    name: 'country'},
            {data: 'police_name', name: 'police_name'},
            {data: 'police_crime', name: 'police_crime'},
