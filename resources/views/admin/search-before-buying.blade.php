...
<head>
    ...
    <title>
    Search before buying Vehicle/Motorbike Data
    </title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> Search before buying Vehicle/Motorbike Data</h4>
                            </div>
                            <div class="card-body">
                                <div class="toolbar">
                                ...
                                <table id="datatable" class="table table-striped table-bordered" cellspacing="0"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Office</th>
                                            <th>Age</th>
                                            <th class="disabled-sorting text-right pr-2">Actions</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                        <tr>
