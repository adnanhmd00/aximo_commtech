...
<head>
  ...
  <link rel="icon" type="image/png" href="../assets/img1/favicon.png">
  ...
  <link href="../assets/css1/paper-dashboard.min1036.css?v=2.1.1" rel="stylesheet" />
...
<body class="">
  ...
  <div class="wrapper ">
    ...
    -->
      <div class="logo">
        <a href="https://www.creative-tim.com/" class="simple-text logo-mini">
          <div class="logo-image-small">
            <img src="../assets/img1/logo-small.png">
          </div>
          <!-- <p>CT</p> -->
        </a>
      ...
      <div class="sidebar-wrapper">
        <div class="user">
          <div class="photo">
            <img src="../assets/img1/faces/ayo-ogunseinde-2.jpg" />
          </div>
          <div class="info">
                      ...
                      <table class="table">
                        <tbody>
                          <tr>
                            <td>
                              <div class="flag">
                                <img src="../assets/img1/flags/US.png">
                              </div>
                            </td>
                            <td>USA</td>
                            <td class="text-right">
                          ...
                          <tr>
                            <td>
                              <div class="flag">
                                <img src="../assets/img1/flags/DE.png">
                              </div>
                            </td>
                            <td>Germany</td>
                            <td class="text-right">
                          ...
                          <tr>
                            <td>
                              <div class="flag">
                                <img src="../assets/img1/flags/AU.png">
                              </div>
                            </td>
                            <td>Australia</td>
                            <td class="text-right">
                          ...
                          <tr>
                            <td>
                              <div class="flag">
                                <img src="../assets/img1/flags/GB.png">
                              </div>
                            </td>
                          ...
                          <tr>
                            <td>
                              <div class="flag">
                                <img src="../assets/img1/flags/RO.png">
                              </div>
                            </td>
                            <td>Romania</td>
                            <td class="text-right">
                          ...
                          <tr>
                            <td>
                              <div class="flag">
                                <img src="../assets/img1/flags/BR.png">
                              </div>
                            </td>
                            <td>Brasil</td>
                            <td class="text-right">
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        ...
                        <td class="img1-row">
                          <div class="img-wrapper">
                            <img src="../assets/img1/faces/ayo-ogunseinde-2.jpg" class="img-raised" />
                          </div>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="img-row">
                          <div class="img-wrapper">
                            <img src="../assets/img1/faces/erik-lucatero-2.jpg" class="img-raised" />
                          </div>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="img-row">
                          <div class="img-wrapper">
                            <img src="../assets/img1/faces/kaci-baum-2.jpg" class="img-raised" />
                          </div>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="img-row">
                          <div class="img-wrapper">
                            <img src="../assets/img1/faces/joe-gardner-2.jpg" class="img-raised" />
                          </div>
                        </td>
  ...
  <!--   Core JS Files   -->
  <script src="../assets/js1/core/jquery.min.js"></script>
  <script src="../assets/js1/core/popper.min.js"></script>
  <script src="../assets/js1/core/bootstrap.min.js"></script>
  <script src="../assets/js1/plugins/perfect-scrollbar.jquery.min.js"></script>
  <script src="../assets/js1/plugins/moment.min.js"></script>
  <!--  Plugin for Switches, full documentation here: http://www.jque.re/plugins/version3/bootstrap.switch/ -->
  <script src="../assets/js1/plugins/bootstrap-switch.js"></script>
  <!--  Plugin for Sweet Alert -->
  <script src="../assets/js1/plugins/sweetalert2.min.js"></script>
  <!-- Forms Validations Plugin -->
  <script src="../assets/js1/plugins/jquery.validate.min.js"></script>
  <!--  Plugin for the Wizard, full documentation here: https://github.com/VinceG/twitter-bootstrap-wizard -->
  <script src="../assets/js1/plugins/jquery.bootstrap-wizard.js"></script>
  <!--	Plugin for Select, full documentation here: http://silviomoreto.github.io/bootstrap-select -->
  <script src="../assets/js1/plugins/bootstrap-selectpicker.js"></script>
  <!--  Plugin for the DateTimePicker, full documentation here: https://eonasdan.github.io/bootstrap-datetimepicker/ -->
  <script src="../assets/js1/plugins/bootstrap-datetimepicker.js"></script>
  <!--  DataTables.net Plugin, full documentation here: https://datatables.net/    -->
  <script src="../assets/js1/plugins/jquery.dataTables.min.js"></script>
  <!--	Plugin for Tags, full documentation here: https://github.com/bootstrap-tagsinput/bootstrap-tagsinputs  -->
  <script src="../assets/js1/plugins/bootstrap-tagsinput.js"></script>
  <!-- Plugin for Fileupload, full documentation here: http://www.jasny.net/bootstrap/javascript/#fileinput -->
  <script src="../assets/js1/plugins/jasny-bootstrap.min.js"></script>
  <!--  Full Calendar Plugin, full documentation here: https://github.com/fullcalendar/fullcalendar    -->
  <script src="../assets/js1/plugins/fullcalendar/fullcalendar.min.js"></script>
  <script src="../assets/js1/plugins/fullcalendar/daygrid.min.js"></script>
  <script src="../assets/js1/plugins/fullcalendar/timegrid.min.js"></script>
  <script src="../assets/js1/plugins/fullcalendar/interaction.min.js"></script>
  <!-- Vector Map plugin, full documentation here: http://jvectormap.com/documentation/ -->
  <script src="../assets/js1/plugins/jquery-jvectormap.js"></script>
  <!--  Plugin for the Bootstrap Table -->
  <script src="../assets/js1/plugins/nouislider.min.js"></script>
  <!--  Google Maps Plugin    -->
  ...
  <script src="../assets/js1/plugins/bootstrap-notify.js"></script>
  <!-- Control Center for Now Ui Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="../assets/js1/paper-dashboard.min1036.js?v=2.1.1" type="text/javascript"></script><!-- Paper Dashboard DEMO methods, don't include it in your project! -->
...
<!-- Mirrored from demos.creative-tim.com/paper-dashboard-2-pro/examples/dashboard.html?_ga=2.82867871.849894201.1621918562-2012631257.1615204035 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 May 2021 04:57:55 GMT -->
</html>