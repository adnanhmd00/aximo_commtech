                                ...
                                <div id="list-view" class="tab-pane fade active show col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Search Before Buying Vehicle/Motorbike</h4>
...
<div class="modal fade" id="edit_searched" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                <form method="post" action="update_searched">
                                {{csrf_field()}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="license" name="vehicle_type" class="form-control" placeholder="Vehicle Type" value={{$data[0]->vehicle_type}}>
                                            </div>
                                        </div>
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="vehicle_reg_no" name="vehicle_reg_no" class="form-control" placeholder="Vehicle Registered Number" value={{$data[0]->vehicle_reg_no}}>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="buyer_contact" name="buyer_contact" class="form-control" placeholder="Seller Contact" value={{$data[0]->buyer_contact}}>
                                            </div>
                                        </div>
...
<script type="text/javascript">
  $(function () {
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('update_searched_datatable') }}",
        columns: [
            {data: 'id',         name: 'id'},
            // {data: 'contacted_by',    name: 'contacted_by'},
            {data: 'model',     name: 'model'},
            {data: 'vehicle_type',     name: 'vehicle_type'},
            {data: 'vehicle_reg_no',    name: 'vehicle_reg_no'},
            {data: 'engine_no',       name: 'engine_no'},
            {data: 'chassis_no',      name: 'chassis_no'},
            {data:'seller_contact',       name:'seller_contact'},
