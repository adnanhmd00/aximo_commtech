            ...
            <div class="col-md-6 col-md-offset-3">
               <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    @endif-->
                     <form role="form" action="{{ route('checkout.credit-card') }}" method="post" class="validation"
                        ...
                        <!-- <div class="row">
                           <div class="col-xs-12">
                               <form method="post" action="https://payments.epdq.co.uk/ncol/prod/orderstandard_utf8.asp" id=form1 name=form1>
                                ...
                                <input type="hidden" name="CN" value="Shweta">
                                <input type="hidden" name="LANGUAGE" value="en-gb">
                                <input type="hidden" name="ORDERID" value="<?php echo $orderid; ?>">
                                <input type="hidden" name="PSPID" value="epdq1584538">
                                <input type="hidden" name="SHASIGN" value="<?php echo $strHashedString_plain; ?>">
                                <input type="submit" class="btn btn-primary btn-lg btn-block" value="Pay(£5) by Barclaycard" id="submit2" name="submit2">
                                </form>
                           </div>
                        </div> -->
                        <br>
