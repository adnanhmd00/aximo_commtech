...
<head>
    <title>Buy Vehicle or Bike Engine</title>
    <!-- headlink -->
    ...
    <section class="cvba-section i-want-to-section">
        <div class="container ">
            <div class="row df-row-cc">
                <div class="col-8 ">
                    <h2 class="contact-title text-center">To Buy Vehicle or Bike Engine</h2>
                </div>
                <div class="col-lg-10">
                    <div>
                        <div class="row div-body">
                            <div class="col-12">
                            @if(session()->has('buy-engine'))
                            <div class="alert alert-danger text-center">
                                {{ session()->get('buy-engine') }}
                            ...
                            @endif
                                <div class="form-1 search-form mt-5">
                                    <form class="needs-validation" action="buy_engine" method="get">
                                        <!--<div class="form-row pb-5">
                                            <div class="col-md-12 d-flex radio-col">
                                                <div class="form-check pr-5">
                                                    <input class="form-check-input form-circle" type="radio" name="vehicle"
                                                        id="flexRadioDefault1" value="vehicle">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input form-circle" type="radio" name="vehicle"
                                                        id="flexRadioDefault1" value="motor">
                                                    <label class="form-check-label radio-text pl-3" for="flexRadioDefault1">
                                                        Motorcycle
                                                    </label>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text my-input"
                                                            id="basic-addon1">*Model of Vehicle or Motorcycle:
                                                            :</span>
                                                    </div>
                                                    <input type="text" class="form-control form-control-3 " name="model" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-3 " name="engine_no" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            {{-- <div class="col-md-6">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text my-input"
                                                            id="basic-addon1">*Mobile No. of seller
                                                            :</span>
                                                    </div>
                                                    <input type="text" class="form-control form-control-3 " name="seller_contact" required>
                                                </div>
                                            </div> --}}
                                            ...
                                            <div class="col-md-6">
                                                <label for="validationMobile" class="form-label">*Email
                                                    of Seller</label>
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control form-control-2" name="seller_email" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            {{-- <div class="col-md-6">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text my-input"
                                                            id="basic-addon1">*Mobile No. of intending buyer
                                                            :</span>
                                                    </div>
                                                    <input type="text" class="form-control form-control-3 " name="buyer_contact" required>
                                                </div>
                                            </div> --}}
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="form-control form-control-2" name="buyer_email" required>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!-- <div class="search-bar">
                                    <div class="slider-btns pb-5">
                                        <form action="#" class="search-box">
                                            <div class="input-form my-input-form">
                                ...
                                <div class="text-center w-100">
                                    <button class="  mb-5 btn btn-primary" type="submit">Next</button>
                                </div>
