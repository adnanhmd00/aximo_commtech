...
<head>
    ...
    <title>Update
        Recovered Vehicle/Motorbike</title>
    <!-- headlink -->
    ...
    <section class="cvba-section i-want-to-section">
        <div class="container ">
            <div class="row df-row-cc">
                <div class="col-8 ">
                    <h2 class="contact-title text-center">Update
                        Recovered Vehicle/Motorbike</h2>
                ...
                <div class="col-lg-8">
                    <div>
                        <div class="row div-body">
                            ...
                            <div class="col-12">
                                <div>
                                    @if (session()->has('recover-email'))
                                        <div class="alert alert-danger text-center">
                                            {{ session()->get('recover-recover') }}
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                    @endif
                                    @if (session()->has('recover-engine'))
                                        <div class="alert alert-danger text-center">
                                            {{ session()->get('recover-engine') }}
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                    @endif
                                    @if (session()->has('recover-chassis'))
                                        <div class="alert alert-danger text-center">
                                            {{ session()->get('recover-chassis') }}
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                    @endif
                                    @if (session()->has('recover-license'))
                                        <div class="alert alert-danger text-center">
                                            {{ session()->get('recover-license') }}
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                ...
                                <div class="form-1 df-row-cc mt-5">
                                    ...
                                    <form class="needs-validation" action="update_recovered" method="get">
                                        {{ csrf_field() }}
                                        <!-- <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control form-control-3 "
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text my-input" id="basic-addon1">*Where
                                                            Recovered city
                                                            :</span>
                                                    </div>
                                                    <input type="text" class="form-control form-control-2"
                                                        name="city_whereRecovered" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <input id="country_selector" class="my-country-report" type="text" readonly name="country_whereRecovered" required>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text my-input"
                                                            id="basic-addon1">*Police Station
                                                            :</span>
                                                    </div>
                                                    <input type="text" class="form-control form-control-2"
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="email"
                                                        ...
                                                        class="form-control form-control-2" name="email" required>
                                                </div>
                                            </div>
