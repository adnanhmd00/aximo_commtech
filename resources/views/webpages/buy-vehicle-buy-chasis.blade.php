...
<head>
    ...
    <title>Buy Vehicle or Bike Chassis</title>
    <!-- headlink -->
    ...
    <section class="cvba-section i-want-to-section">
        <div class="container ">
            <div class="row df-row-cc">
                <div class="col-8 ">
                    <h2 class="contact-title text-center">To Buy Vehicle / Bike Chassis</h2>
                ...
                <div class="col-lg-10">
                    <div>
                        <div class="row div-body">
                            <div class="col-12">
                                @if (session()->has('buy-chassis'))
                                    <div class="alert alert-danger text-center">
                                        {{ session()->get('buy-chassis') }}
                                ...
                                <div class="form-1 search-form mt-5">
                                    <form class="needs-validation" method="get" action="buy_chassis">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="email"
                                                        ...
                                                        class="form-control form-control-2" name="seller_email"
                                                        required>
                                                </div>
                                            </div>
