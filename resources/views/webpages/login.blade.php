                                    ...
                                    <form class="needs-validation" method="post"  action="/api/login">
                                        ...
                                        <div class="form-row">
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="email" class="form-control form-control-2"
                                                        id="validationServerUsername" placeholder="Email or Mobile"
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input type="password" name="password" class="form-control form-control-2"
                                        ...
                                        <div class="col-md-12 mb-3 p-0">
                                            <div>
                                                <a href="signup" style="float:left;">
                                                    <p class="login">Not a member Yet? Sign Up </p>
                                                </a>
